...
<h2>🌡️ GreenSense 🌱 </h2>
<h3>Real time IoT full stack application that provides real time temperature & humidity data, providing Artificial Intelligence suggestions about how to save energy for users. </h3>
Co-Contributors:
